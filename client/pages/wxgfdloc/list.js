...
var callBackQuery = function(res, th) {
  ...
  obj.forEach(function(item, index) {
    ...
    gfdmx.forEach(function(item2, index2) {
      item2.gfsl = Api.slrenderer(item2.gfsl);
      item2.gfzl = Api.slrenderer(item2.gfzl);
    })
    item['gfdmx'] = gfdmx;
  });
...
Page({
  ...
  edit: function (e) {
    ...
    var that = this;
    var obj1 = e.currentTarget.dataset;
    if (obj1.id == undefined) return;
    var id = obj1.id;
    ...
    var url = '../wxgfdsh/edit/edit?act=1&obj=' + objstr;
     
  //  url = '../wxgfdview/edit?level=1&id='+id;
    wx.navigateTo({
      url: url
    })
  },
